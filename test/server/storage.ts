...
export class MemStorage implements IStorage {
  ...
  private seedData() {
    ...
    const keywords = [
      {
        keyword: "omaha real estate agent",
        currentRank: 3,
        searchVolume: 1200,
        difficulty: 75,
      },
      {
        keyword: "dundee homes for sale",
        currentRank: 1,
        searchVolume: 450,
        difficulty: 45,
        neighborhood: "Dundee",
      ...
      {
        keyword: "aksarben luxury condos",
        currentRank: 7,
        searchVolume: 320,
        difficulty: 60,
  ...
  async getMarketDataByNeighborhood(
    ...
    return Array.from(this.marketData.values()).find(
      (data) => data.neighborhood === neighborhood
    );
  }
  ...
  async getScheduledPosts(
    ...
    const userPosts = Array.from(this.scheduledPosts.values()).filter(
  ...
  async updateScheduledPost(
    ...
    const updated = {
      ...
      updatedAt: new Date(),
      isEdited:
        updates.content && updates.content !== post.originalContent
          ? true
          : post.isEdited,
    };
  ...
  async getVideoContent(
    ...
    const userVideos = Array.from(this.videoContent.values()).filter(
