...
export function MenuItemSelector({ 
  ...
  const createItemMutation = useMutation({
    ...
    onSuccess: (newItem) => {
      toast({ title: "Item Created", description: "New menu item added successfully" });
    ...
    <div className="space-y-4 max-h-[60vh] overflow-y-auto pr-2">
      ...
      <div>
        ...
        <Textarea
          ...
          placeholder="Mozzarella, tomato sauce, fresh basil, olive oil..."
          rows={2}
        />
      </div>
      ...
      <div className="flex gap-4">
        ...
        <div className="flex items-center gap-2">
          ...
          <Label htmlFor="is-chef-recommended" className="flex items-center gap-1">
            <ChefHat className="h-4 w-4 text-purple-500" /> Chef's Pick
          </Label>
        </div>
      </div>
      ...
      <div>
        ...
        <Input
          ...
          placeholder="bestseller, house-special, new..."
        />
      </div>
    </div>
  );
          ...
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input
                ...
                placeholder="Traditional Italian pizzas..."
              />
            </div>
            <div>
              <Label>Icon</Label>
